...
describe BinaryGame do
  ...
  describe '#verify_input' do
    subject(:game_play) { described_class.new(1, 10) }
    ...
    context 'when given a valid input as argument' do
      it 'returns valid input' do
        min = game_play.instance_variable_get(:@minimum)
        max = game_play.instance_variable_get(:@maximum)
        input = game_play.instance_variable_get(:@input)
        result = game_play.verify_input(min, max, 3)
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        ...
        max = game_play.instance_variable_get(:@maximum)
        input = game_play.instance_variable_get(:@input)
        result = game_play.verify_input(min, max, 99)
